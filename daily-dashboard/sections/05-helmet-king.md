...
- 保險：主來源 = **CostGo 續保** `costgo_renewal_cases`（6月 43 宗、gross_premium $62,725）。**純利 = gross_premium × 15%**（老闆定 renew≈15%；config `commission_pct` 可改）→ 6月 ≈ $9,409。
- 旅行團：併入報數（無 target，來源待確認）。
> 驗證(6/27)：零售 ~$411,761 + 車房 ~$146,665 + 賣車 $196,824 + 租車 $3,640 + 保險 ~$9,409 ≈ **$768,299** / 目標 100萬（77%，應達 90% → 落後）。
