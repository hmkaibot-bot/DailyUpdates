...
- 保險：`insurance_monthly_summary('YYYY-MM').profit_total` ＋ CostGo 毛利；**現時停更，6 月 $0**（見 config data_gap）。
- 旅行團：併入報數（無 target，來源待確認）。
> 驗證(6/27)：零售 ~$411,761 + 車房 ~$146,665 + 賣車 $196,824 + 租車 $3,640 + 保險 $0 ≈ **$758,890** / 目標 100萬（76%，應達 90% → 落後）。
