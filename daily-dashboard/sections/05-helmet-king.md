...
> 範例驗算(6/27)：411,761 + 146,665 + 196,824 + 3,640 + 9,409 + 52,000 = **$820,299** / 100萬 = 82.0%（應達 90% → 落後）。實際每日重算，數字會變，但**格式固定要有總數**。
...
━━ 集團總 GP(估)  $820,299     $1.0M    82.0%    $179,701  ← 必填實際算出的數字，不可空白
👉 跨線洞察（哪條最落後、最該追）
```
