...
月目標亦已按新口徑重訂：**$250k 係「毛利」目標，唔係營業額目標**（`monthly_targets.garage.basis = gross_profit`）。
→ 追數攞 **`g_gp`** 同 $250k 比，**唔好攞 `g_mtd`（營業額）去比**，否則會高估達成率約 1.4 倍。
按 2026-09 實測毛利率 71.4% 反推，$250k 毛利 ≈ 需要 **$350k/月營業額**（約 $11,670/日）。
