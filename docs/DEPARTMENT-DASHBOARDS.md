...
### #車房（garage-system —— 2026-09-01 起唯一權威）
- 昨日營業額(garage-system 已交車工單) vs 前日；上週同日／上月同期要睇 Q3b 嘅 comparable flag（未夠比較期就出「—」，唔准 fallback BC）
- 本月毛利（收入 − 零件成本；師傅人工唔入 GP，係公司會計口徑）
- 月目標 $250k —— **係毛利目標，唔係營業額目標**（2026-09-04 拍板）。追數攞 g_gp 比，唔好攞營業額比。
